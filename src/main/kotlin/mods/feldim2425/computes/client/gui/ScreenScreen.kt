...
class ScreenScreen(screenContainer: ScreenContainer, inv: PlayerInventory, titleIn: ITextComponent) :
    ...
    init {
        this.xSize = this.container.tileentity.getBuffer().size.first * 6 + 4
        this.ySize = this.container.tileentity.getBuffer().size.second * 10 + 4

        renderer = TermTextRenderer(this.container.tileentity.getBuffer())
    }
